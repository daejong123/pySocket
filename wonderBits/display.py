...
class Display(Wonderbits):
    ...
    def draw_dot(self, x, y, pageNum, saved = 0, writeColor = 1):
        command = 'display{}.draw_dot({},{},{},{},{})'.format(self.index,x,y,pageNum,saved,writeColor)
        self.set_command(command)
    
    def draw_line(self, headX, headY, tailX, tailY, pageNum, saved = 0, writeColor = 1):
        command = 'display{}.draw_line({},{},{},{},{},{},{})'.format(self.index,headX,headY,tailX,tailY,pageNum,saved,writeColor)
        self.set_command(command)
    ...
    def set_coordinate(self, row, column):
        command = 'display{}.set_coordinate({},{})'.format(self.index,row,column)
        self.set_command(command)
